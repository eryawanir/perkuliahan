@csrf
<div class="row mb-3">
  <label for="nik" class="col-md-3 col-form-label text-md-end" title="8 digit angka nik">
    NIK</label>
  <div class="col-md-4">
    <input id="nik" type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" value="{{ old('nik') ?? ($dosen->nik ?? '') }}" autofocus>
    @error('nik')
...
<div class="row mb-3">
  <label for="nama" class="col-sm-6 col-md-3 ol-form-label text-md-end">
    Nama Dosen </label>
  <div class="col-md-4">
    <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') ?? ($dosen->nama ?? '') }}">
    @error('nama')
      <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
      </span>
