...
<div class="row mb-3">
  ...
  <div class="col-md-4">
    <input name="kode" id="kode" type="text" autofocus class="form-control @error('kode') is-invalid @enderror" value="{{ old('kode') ?? ($matakuliah->kode ?? '') }}">
    @error('kode')
...
<div class="row mb-3">
  ...
  <div class="col-md-4">
    <input name="nama" id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') ?? ($matakuliah->nama ?? '') }}">
    @error('nama')
      <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
      </span>
